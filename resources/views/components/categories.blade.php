    ...
    @foreach($subjects as $subjectName => $subject)
        ...
        @foreach($subject as $category)
            ...
            <div style="margin-left: 30px   ">
                <input onchange="this.form.submit()" name="genre[]" value="{{ $loop->parent->iteration . "," . $loop->iteration + 1}}" {{ in_array($loop->parent->iteration . "," . $loop->iteration + 1, $filters) ? "checked" : "" }} type="checkbox">
